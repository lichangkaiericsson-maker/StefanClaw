...
[![Version](https://img.shields.io/badge/version-0.2.0--beta.4-blue)](https://github.com)
[![Platform](https://img.shields.io/badge/platform-macOS%2012%2B-lightgrey)](https://github.com)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)

## Overview

StefanClaw is a macOS desktop application built on top of **OpenClaw** (v2026.3.8), an open-source multi-channel AI gateway. It connects large language models to real-world tools, messaging platforms, and automation workflows through an extensible Agent + Skill architecture.
...
### 🔒 Local-first & Privacy
- All AI inference runs locally via Ollama integration
...
```
StefanClaw.app (Electron shell)
└── OpenClaw Engine (Node.js / MJS)
...
| Python Runtime | uv (bundled, 43MB) |
| Memory Store | LanceDB (vector embeddings) |
| LLM Backend | Ollama (local) / Cloud APIs |
| Auto-update | generic provider via `oss.intelli-spectrum.com` |

## Download

See [Releases](../../releases) for the latest macOS build.
